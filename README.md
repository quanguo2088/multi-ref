...
│       ├── sequencing_data/                      # Sequencing reads (FASTQ format)
│       ├── Compile.sh                            # Compilation script
│       └── Bootstrap_recovery_stage1_2.sh        # Run Stage 1+2 of bootstrap recovery
...
│       ├── sequencing_data/                      # Sequencing reads (FASTQ format)
│       ├── Compile.sh                            # Compilation script
│       └── Bootstrap_recovery_stage1_2_3.sh      # Run Stage 1+2+3 of bootstrap recovery
```
...
### 2. Bootstrap Recovery stage 1 (R = 5/6)
...
#### [Step 1–2] Scaffold reference generation & Filtering Type-II reads
...
### ➤ Stage 1 & Stage 2: *(see above)*

### ➤ Stage 3:

#### [Step 1–2] Regenerative reference generation & Filtering Type-III reads

...
We designed and synthesized four ~40 kb large DNA fragments using watermark superposition coding, respectively encoding Tagore's poem *Dreams* (DNA-40.5Kb-DR, R = 1/4), the emblem of Tianjin University (DNA-40.5Kb-EM, R = 2/3), the image *Earthrise* (DNA-40.32Kb-ER, R = 1/2) and the image *Milk Coronet* (DNA-40.5Kb-MC, R = 5/6).We provide both raw sequencing reads generated by Illumina and simulated reads generated using the ART simulator. For  fast recovery , we provide the corresponding data files and programs for DNA-40.5Kb-EM (R = 2/3) and  DNA-40.32Kb-ER (R = 1/2) . For  bootstrap recovery , we provide the data files and programs for DNA-40.32Kb-ER (R = 1/2) and DNA-40.5Kb-MC (R = 5/6) that support error-free decoding.
...
**To run fast recovery for DNA-40.32Kb-ER (R=1/2), use the following command:**
...
**To run fast recovery for the DNA-40.32Kb-ER (R=1/2), use the following command:**
